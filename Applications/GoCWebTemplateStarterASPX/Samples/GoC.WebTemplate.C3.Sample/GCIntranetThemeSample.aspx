...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Set programmatically via the <code class="wb-prettify">"WebTemplateCore.ApplicationTitle_Text"</code>.
    <p>The URL for the Application Title is optional.  If left blank the subTheme will determine the URL to use.  You can override the default URL value of the subTheme by setting programmatically the <code class="wb-prettify">"WebTemplateCore.ApplicationTitle_URL"</code> property of the Web Template.</p>
