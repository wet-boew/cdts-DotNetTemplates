...
namespace GoC.WebTemplate.MVC.Sample.Controllers
{
    public class GoCWebTemplateSampleController : WebTemplateBaseController
    {
        ...
        public GoCWebTemplateSampleController(IStringLocalizer<Program> localizer, IMemoryCache memCache, IHostingEnvironment env, IOptions<GCConfigurations> config, IHttpContextAccessor context) : base(memCache, env, config, context.HttpContext.Request)
        {
