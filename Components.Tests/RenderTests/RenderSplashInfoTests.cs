...
namespace GoC.WebTemplate.Components.Test.RenderTests
{
    public class RenderSplashInfoTests
    {
        ...
        public void RenderSplashInfoTest(Model sut)
        {
            ...
            result.ToString().Should().Be("{\"cdnEnv\":\"\",\"indexEng\":\"http://www.canada.ca/en/index.html\",\"indexFra\":\"http://www.canada.ca/fr/index.html\",\"termsEng\":\"http://www.canada.ca/en/transparency/terms.html\",\"termsFra\":\"http://www.canada.ca/fr/transparence/avis.html\",\"nameEng\":\"[My web asset]\",\"nameFra\":\"[Mon actif web]\",\"languagePrecedence\":\"English\"}");
        }
    }
}
