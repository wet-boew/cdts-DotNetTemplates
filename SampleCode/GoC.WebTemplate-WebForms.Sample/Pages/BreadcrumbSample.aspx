<%@ Page Title="" Language="C#" MasterPageFile="~/GoC.WebTemplate/GoCWebTemplate.Master" AutoEventWireup="true" CodeBehind="BreadcrumbSample.aspx.cs" Inherits="GoC.WebTemplate.WebForm.Sample.Pages.BreadcrumbSample" %>
...
this.WebTemplateMaster.WebTemplateCore.Breadcrumbs.Add(new Breadcrumb("http://www.esdc.gc.ca/en/jobs/opportunities/youth_students.page", "Opporunities", ""));
