...
<p>In the AKAMAI environment, you can only change the <code class="wb-prettify">"href"</code> of ContactLinks.</p>
<p>In the Application template, if not in the AKAMAI environment, you cannot use ContactLinks. You can use a CustomFooter instead.</p>
<p>In Intranet (ESDC_Prod) and Extranet (PROD_SSL) you can change the <code class="wb-prettify">"href"</code> and <code class="wb-prettify">"text"</code> of ContactLinks.</p>
